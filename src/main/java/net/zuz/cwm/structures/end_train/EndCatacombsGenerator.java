    ...
    static {
        POOL = StructurePools.register
                (new StructurePool(new Identifier("cwm", "end_catacombs_pool"),
                        ...
                        ImmutableList.of(
                                Pair.of(StructurePoolElement.ofLegacySingle("end_catacombs/end_catacombs_corridor_1"), 1),
                                ...
                                Pair.of(StructurePoolElement.ofLegacySingle("end_catacombs/end_catacombs_corridor_4"), 2),
                                Pair.of(StructurePoolElement.ofLegacySingle("end_catacombs/end_catacombs_upstairs_1"), 2),
                                Pair.of(StructurePoolElement.ofLegacySingle("end_catacombs/end_catacombs_crossing_1"), 1),
                                Pair.of(StructurePoolElement.ofLegacySingle("end_catacombs/end_catacombs_crossing_2"), 3),
        ...
        StructurePools.register
                (new StructurePool(new Identifier("cwm", "end_catacombs_treasure"),
                        ...
                        ImmutableList.of(
                                ...
                                Pair.of(StructurePoolElement.ofLegacySingle("end_catacombs/treasure/end_catacombs_candle_1"), 4),
                                Pair.of(StructurePoolElement.ofLegacySingle("end_catacombs/treasure/end_catacombs_candle_2"), 3),
                                Pair.of(StructurePoolElement.ofLegacySingle("end_catacombs/treasure/end_catacombs_candle_3"), 1),
                                Pair.of(StructurePoolElement.ofLegacySingle("end_catacombs/treasure/end_catacombs_candle_4"), 2)
