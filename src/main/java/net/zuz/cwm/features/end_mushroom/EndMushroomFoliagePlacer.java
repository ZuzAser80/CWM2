...
public class EndMushroomFoliagePlacer extends FoliagePlacer {
    ...
    public static final Codec<EndMushroomFoliagePlacer> CODEC = RecordCodecBuilder.create(instance ->
            fillFoliagePlacerFields(instance)
                    .and(IntProvider.createValidatingCodec(1, 512).fieldOf("foliage_height").forGetter(EndMushroomFoliagePlacer::getFoliageHeight))
                            .apply(instance, EndMushroomFoliagePlacer::new));

    private final IntProvider foliageHeight;

    public EndMushroomFoliagePlacer(IntProvider radius, IntProvider offset, IntProvider foliageHeight) {
        super(radius, offset);
    ...
    protected FoliagePlacerType<?> getType() {
        return EndMushroomFeature.RICH_FOLIAGE_PLACER;
    }
