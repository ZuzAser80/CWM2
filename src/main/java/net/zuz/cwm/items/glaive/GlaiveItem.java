...
public class GlaiveItem extends SwordItem {
    ...
    public Multimap<EntityAttribute, EntityAttributeModifier> getAttributeModifiers(EquipmentSlot slot) {
        ...
        if (slot == EquipmentSlot.MAINHAND) {
            ...
            builder.put(EntityAttributes.GENERIC_ATTACK_SPEED, new EntityAttributeModifier(INCREASE_UUID, "Glaive speed increase", 1f, EntityAttributeModifier.Operation.ADDITION));
        }
